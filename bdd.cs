...
namespace Digital_Fishing
{
    public class bdd
    {
        ...
        public static void InsertContrat(string la, double mttB, double mttN, int etat, bool fact, bool agessa, Pigiste lePigiste, Magazine leMagazine)
        {
            ...
            string query = "INSERT INTO Contrat (LettreAccordCollaboration, MontantCollaboration, MontantNCollaboration, EtatCollaboration, FactureCollaboration, AgessaCollaboration, PigisteContrat, MagazineContrat) VALUES('" + la + "','" + mttB + "','" + mttN + "'," + etat + "'," + fact + "'," + agessa + "'," + lePigiste.NumPigiste + "'," + leMagazine.NumMagazine + ")";
            Console.WriteLine(query);
        ...
        {
            //Update Contrat
            string query = "UPDATE Contrat SET LettreAccordContrat='" + la + "', MontantCollaboration='" + mttB + "', MontantNCollaboration = " + mttNet + "', EtatCollaboration = " + etat + "', FactureCollaboration = " + fact + "', AgessaCollaboration = " + agessa + "', NumPigiste = " + NumPigiste + "', NumMagazine = " + NumMagazine + " WHERE NumCollaboration=" + numC;
            Console.WriteLine(query);
        ...
        public static List<Contrat> SelectContrat()
        {
            ...
            if (bdd.OpenConnection() == true)
            {
                ...
                while (dataReader.Read())
                {
                    Contrat leContrat = new Contrat(Convert.ToInt16(dataReader["NumCollaboration"]), Convert.ToString(dataReader["LettreAccordCollaboration"]), Convert.ToInt16(dataReader["EtatCollaboration"]), Convert.ToInt16(dataReader["AgessaCollaboration"]), Convert.ToBoolean(dataReader["FactureCollaboration"]), Convert.ToBoolean(dataReader["MontantCollaboration"]), Convert.ToInt16(dataReader["MontantNCollaboration"]), (Pigiste)dataReader["NumPigiste"], (Magazine)dataReader["NumMagazine"]);
